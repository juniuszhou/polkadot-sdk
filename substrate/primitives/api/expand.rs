...
pub mod __private {
    ...
    pub use sp_runtime::{
        ...
        transaction_validity::TransactionValidity, ExtrinsicInclusionMode, RuntimeString,
        TransactionOutcome,
    };
...
use sp_state_machine::{
    backend::AsTrieBackend, Backend as StateBackend, OverlayedChanges,
};
...
pub enum ApiError {
    ...
    FailedToConvertReturnValue { function: &'static str, #[source] error: codec::Error },
    #[error(
        "Failed to convert parameter `{parameter}` from node to runtime of {function}"
    )]
...
impl ::core::fmt::Debug for ApiError {
    ...
    fn fmt(&self, f: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        match self {
            ...
            ApiError::UsingSameInstanceForDifferentBlocks => {
...
impl std::error::Error for ApiError {
    fn source(&self) -> ::core::option::Option<&(dyn std::error::Error + 'static)> {
        ...
        match self {
            ...
            ApiError::StateBackendIsNotTrie { .. } => ::core::option::Option::None,
            ApiError::Application { 0: transparent } => {
                std::error::Error::source(transparent.as_dyn_error())
            }
            ApiError::UnknownBlock { .. } => ::core::option::Option::None,
            ApiError::UsingSameInstanceForDifferentBlocks { .. } => {
...
impl ::core::fmt::Display for ApiError {
    fn fmt(&self, __formatter: &mut ::core::fmt::Formatter) -> ::core::fmt::Result {
        ...
        match self {
            ApiError::FailedToDecodeReturnValue { function, error, raw } => {
                __formatter
                    .write_fmt(
                        format_args!(
                            "Failed to decode return value of {0}: {1} raw data: {2:?}",
                            function.as_display(),
                            error.as_display(),
                            raw,
                        ),
            ...
            ApiError::FailedToConvertReturnValue { function, error } => {
                __formatter
                    .write_fmt(
                        format_args!(
                            "Failed to convert return value from runtime to node of {0}",
                            function.as_display(),
                        ),
                    )
            }
            ApiError::FailedToConvertParameter { function, parameter, error } => {
                __formatter
                    .write_fmt(
                        format_args!(
                            "Failed to convert parameter `{0}` from node to runtime of {1}",
                            parameter.as_display(),
                            function.as_display(),
                        ),
                    )
            }
            ApiError::StateBackendIsNotTrie {} => {
                __formatter
                    .write_fmt(
                        format_args!("The given `StateBackend` isn\'t a `TrieBackend`."),
                    )
            }
            ApiError::Application(_0) => ::core::fmt::Display::fmt(_0, __formatter),
            ApiError::UnknownBlock(_0) => {
                __formatter
                    .write_fmt(
                        format_args!(
                            "Api called for an unknown Block: {0}",
                            _0.as_display(),
                        ),
                    )
            }
            ApiError::UsingSameInstanceForDifferentBlocks {} => {
                __formatter
                    .write_fmt(
                        format_args!(
                            "Using the same api instance to call into multiple independent blocks.",
                        ),
                    )
            }
        }
...
#[allow(unused_qualifications)]
impl ::core::convert::From<Box<dyn std::error::Error + Send + Sync>> for ApiError {
    #[allow(deprecated)]
...
pub const fn serialize_runtime_api_info(
    id: [u8; 8],
    version: u32,
) -> [u8; RUNTIME_API_INFO_SIZE] {
...
pub fn deserialize_runtime_api_info(
...
pub mod runtime_decl_for_core {
    ...
    pub trait CoreV5<Block: sp_api::__private::BlockT> {
...
pub mod runtime_decl_for_metadata {
    ...
    pub trait MetadataV2<Block: sp_api::__private::BlockT> {
...
/// The `Core` runtime api that every Substrate runtime needs to implement.
pub trait Core<Block: sp_api::__private::BlockT>: 'static + Send {
    /// Returns the version of the runtime.
    fn version(
        &self,
        __runtime_api_at_param__: <Block as sp_api::__private::BlockT>::Hash,
    ) -> std::result::Result<RuntimeVersion, sp_api::__private::ApiError> {
        ...
        >>::__runtime_api_internal_call_api_at(
            ...
            .and_then(|r| std::result::Result::map_err(
                <RuntimeVersion as sp_api::__private::Decode>::decode(&mut &r[..]),
    ...
    fn initialize_block(
        ...
        __runtime_api_at_param__: <Block as sp_api::__private::BlockT>::Hash,
        header: &<Block as BlockT>::Header,
    ) -> std::result::Result<ExtrinsicInclusionMode, sp_api::__private::ApiError> {
        let __runtime_api_impl_params_encoded__ = sp_api::__private::Encode::encode(
            &(&header),
        );
        <Self as Core<
        ...
        >>::__runtime_api_internal_call_api_at(
                ...
                __runtime_api_at_param__,
                __runtime_api_impl_params_encoded__,
                &(|_version| { "Core_initialize_block" }),
            )
            .and_then(|r| std::result::Result::map_err(
                <ExtrinsicInclusionMode as sp_api::__private::Decode>::decode(
                    &mut &r[..],
                ),
                |err| sp_api::__private::ApiError::FailedToDecodeReturnValue {
                    function: "Core_initialize_block",
...
/// The `Metadata` api trait that returns metadata for the runtime.
pub trait Metadata<Block: sp_api::__private::BlockT>: sp_api::__private::Core<Block> {
    /// Returns the metadata of a runtime.
    fn metadata(
        &self,
        __runtime_api_at_param__: <Block as sp_api::__private::BlockT>::Hash,
    ) -> std::result::Result<OpaqueMetadata, sp_api::__private::ApiError> {
        let __runtime_api_impl_params_encoded__ = sp_api::__private::Encode::encode(&());
        <Self as Metadata<
            _,
        >>::__runtime_api_internal_call_api_at(
            ...
            .and_then(|r| std::result::Result::map_err(
                <OpaqueMetadata as sp_api::__private::Decode>::decode(&mut &r[..]),
                |err| sp_api::__private::ApiError::FailedToDecodeReturnValue {
    ...
    fn metadata_at_version(
        ...
        __runtime_api_at_param__: <Block as sp_api::__private::BlockT>::Hash,
        version: u32,
    ) -> std::result::Result<Option<OpaqueMetadata>, sp_api::__private::ApiError> {
        let __runtime_api_impl_params_encoded__ = sp_api::__private::Encode::encode(
            &(&version),
        );
        <Self as Metadata<
    ...
    fn metadata_versions(
        &self,
        __runtime_api_at_param__: <Block as sp_api::__private::BlockT>::Hash,
    ) -> std::result::Result<sp_std::vec::Vec<u32>, sp_api::__private::ApiError> {
        let __runtime_api_impl_params_encoded__ = sp_api::__private::Encode::encode(&());
        <Self as Metadata<
            _,
        >>::__runtime_api_internal_call_api_at(
...
impl<Block: sp_api::__private::BlockT> sp_api::__private::RuntimeApiInfo
for dyn Metadata<Block> {
    const ID: [u8; 8] = [55u8, 227u8, 151u8, 252u8, 124u8, 145u8, 245u8, 228u8];
    const VERSION: u32 = 2u32;
}
#[doc(hidden)]
pub use _std_enabled as std_enabled;
#[doc(hidden)]
pub use _std_disabled as std_disabled;
#[doc(hidden)]
pub use _frame_metadata_enabled as frame_metadata_enabled;
